...
## LinkedIn (short — DM / connection note)

Emir — you're hiring a Founding GTM Engineer to build Sim's go-to-market data layer from zero. So I built the first piece of it, on your data:
...
**Subject:** Built your stargazer → enterprise pipeline (Sim's data, live link)

Hi Emir,

You're hiring your first Founding GTM Engineer to architect Sim's GTM and RevOps infrastructure — the JD even names Clay, scraping, and web-indexing. That's the exact problem I build for, so instead of a cover letter I built a working piece of it on your own data.
...
I sit at the intersection of GTM strategy, AI automation, and engineering execution — the founding-GTM-operator / forward-deployed profile. I'll be at the AI Engineer World's Fair (Jun 29–Jul 2, Moscone West). Worth 15 minutes there?

Best,
Marco Milanello
marcomilanello.it · costruisco sistemi, non slide

---

## Notes for Marco (IT)
- Apri sempre con l'**osservazione** (stanno assumendo il founding GTM) → "ho costruito X" → link → **una** CTA (15 min al Fair). Zero hype, niente "I'd love the opportunity".
- Se il ruolo risultasse già chiuso, l'angolo tiene lo stesso: "ecco come gestirei il vostro GTM data layer".
- Waleed (CTO): se rispondi a lui, sposta l'enfasi sull'**ingegneria** della pipeline (identity resolution, refresh, CRM sync).
